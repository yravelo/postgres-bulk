...
public interface PostgresBulkRepository<T, ID> extends BulkOperations<T> {
   ...
   * @throws io.github.postgresbulk.core.BulkException if the operation cannot complete
   */
  @Override
  @Transactional
   ...
   * @throws io.github.postgresbulk.core.BulkException if temporary-table, COPY, query, or cleanup
   *     work fails
   */
  @Transactional
