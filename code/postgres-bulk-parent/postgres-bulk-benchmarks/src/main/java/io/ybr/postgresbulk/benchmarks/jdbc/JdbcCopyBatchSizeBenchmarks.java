...
@Threads(1)
public class JdbcCopyBatchSizeBenchmarks {

  @Benchmark
  public int postgresBulkJdbcBatchSize(CopyBatchState state) {
    return state.environment.postgresBulkJdbc(state.rows, state.batchSize);
  }
